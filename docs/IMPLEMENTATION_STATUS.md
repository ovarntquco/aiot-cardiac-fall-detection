...
| UC2 | FR2-FR3 | Thu thap du lieu cam bien | `backend/src/modules/sensor-data`, `iot-firmware/docs/PLACEHOLDER_MODULES.md` | PARTIAL - UC8 ingestion adapter only |
...
| UC8 | FR12 | Phat hien bat thuong tim mach | `backend/src/modules/cardiac-detection` | IMPLEMENTED |
...
| UC2 | `backend/src/modules/sensor-data` | `index.js` | Connect the implemented UC8 ingestion adapter to the real wearable transport and collection cadence. | Device transport |
